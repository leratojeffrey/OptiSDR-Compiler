...
import collection.mutable.{HashSet, HashMap, Stack}
/**
...
object Config {
  ...
  var performRun: Boolean = getProperty("delite.run", "true") != "false"
	var OpIOvisited: Boolean = true
	var syncsize = "1000000"; //TODO: Set Default Parallel Loop Sync to 1M
	var streamsize = "2048"; // This is changed by the compiler depending on use specification
	val MaxStreamDataSize = 1300*2048; // TODO: Must get this Stuff straight from cudaDeviceProperties
  ...
  val printSources: Boolean = getProperty("delite.debug.print.sources", "false") != "false"
	val cufft: Boolean = getProperty("delite.debug.cufft", "false") != "false"
	var optisdrtimerset:Boolean = getProperty("delite.debug.profile", "false") != "false"

  var degFilename = System.getProperty("delite.deg.filename", "out.deg")
  var tempDeviceVars = new Stack[String]
  var deviceVars = new HashMap[String, String]
  /**
