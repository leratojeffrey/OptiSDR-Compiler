...
trait LanguageOps extends Base { this: OptiLA =>
  ...
  def sqrt(e: Rep[Double]): Rep[Double]
  ...
  def log(x: Rep[Double]): Rep[Double] = optila_scalar_log(x)
  ...
  //
  // We need this Floats fro OptiSDR
  //def sqrt(e: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  //def ceil(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float] 
  //def floor(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def exp(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  //def log(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float] = optila_scalar_log(x)
  def log10(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def sin(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def sinh(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def asin(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def cos(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def cosh(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def acos(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def tan(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def tanh(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]  
  def atan(x: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  def atan2(x: Rep[Float], y: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  //def pow(x: Rep[Float], y: Rep[Float])(implicit ctx: SourceContext): Rep[Float]
  //
  //
...
trait LanguageOpsExp extends LanguageOps with BaseFatExp with EffectExp {
  ...
  def identityHashCode(x:Exp[Any])(implicit ctx: SourceContext) = reflectPure(IdentityHashCode(x))
	//
	// Trying these for OptiSDR - We use lots of Memory when Double, we want Float
	//
	//def sqrt(e: Exp[Float])(implicit ctx: SourceContext) = Math.sqrt(e).toFloat  
  //def ceil(x: Exp[Float])(implicit ctx: SourceContext) = Math.ceil(x).toFloat
  //def floor(x: Exp[Float])(implicit ctx: SourceContext) = Math.floor(x).toFloat
  def log10(x: Exp[Float])(implicit ctx: SourceContext) = Math.log10(x).toFloat
  def exp(x: Exp[Float])(implicit ctx: SourceContext) = Math.exp(x).toFloat
  def sin(x: Exp[Float])(implicit ctx: SourceContext) = Math.sin(x).toFloat
  def sinh(x: Exp[Float])(implicit ctx: SourceContext) = Math.sinh(x).toFloat
  def asin(x: Exp[Float])(implicit ctx: SourceContext) = Math.asin(x).toFloat
  def cos(x: Exp[Float])(implicit ctx: SourceContext) = Math.cos(x).toFloat
  def cosh(x: Exp[Float])(implicit ctx: SourceContext) = Math.cosh(x).toFloat
  def acos(x: Exp[Float])(implicit ctx: SourceContext) = Math.acos(x).toFloat
  def tan(x: Exp[Float])(implicit ctx: SourceContext) = Math.tan(x).toFloat
  def tanh(x: Exp[Float])(implicit ctx: SourceContext) = Math.tanh(x).toFloat
  def atan(x: Exp[Float])(implicit ctx: SourceContext) = Math.atan(x).toFloat
  def atan2(x: Exp[Float], y: Exp[Float])(implicit ctx: SourceContext) = Math.atan2(x,y).toFloat
  //def pow(x: Exp[Float], y: Exp[Float])(implicit ctx: SourceContext) = Math.pow(x,y).toFloat
  /**
   * aliases for scala.math._ operations supported by optila
   */
  def sqrt(e: Exp[Double]) = Math.sqrt(e)   
  ...
  def log10(x: Exp[Double]) = Math.log10(x)
  def exp(x: Exp[Double])= Math.exp(x)
  def sin(x: Exp[Double]) = Math.sin(x)
  def sinh(x: Exp[Double]) = Math.sinh(x)
  def asin(x: Exp[Double]) = Math.asin(x)
  def cos(x: Exp[Double]) = Math.cos(x)
  def cosh(x: Exp[Double])= Math.cosh(x)
  def acos(x: Exp[Double]) = Math.acos(x)
  def tan(x: Exp[Double]) = Math.tan(x)
  def tanh(x: Exp[Double]) = Math.tanh(x)  
  def atan(x: Exp[Double]) = Math.atan(x)
  def atan2(x: Exp[Double], y: Exp[Double]) = Math.atan2(x,y)
